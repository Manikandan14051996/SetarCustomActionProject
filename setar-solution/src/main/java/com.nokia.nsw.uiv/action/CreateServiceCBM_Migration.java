...
@Action
@Slf4j
public class CreateServiceCBM_Migration implements HttpAction {
    ...
    public Class<?> getActionClass() {
        return CreateServiceCBMBulkRequest.class;
    }
    ...
    public Object doPost(ActionContext actionContext) throws Exception {
        ...
        List<CreateServiceCBMResponse> responses = new ArrayList<>();
            CreateServiceCBMBulkRequest bulkRequest =
                    (CreateServiceCBMBulkRequest) actionContext.getObject();

            List<CreateServiceCBMRequest> requests = bulkRequest.getServices();
