...
public class CreateServiceVoIP_Migration implements HttpAction {
    ...
    @Autowired
    private CreateServiceVoIP_Migration self;
    @Override
    ...
    public CreateServiceVoIPResponse singleReqprocess(CreateServiceVoIPRequest req) throws BadRequestException {
        CreateServiceVoIPResponse response =null;
        ...
        response=new CreateServiceVoIPResponse(
                "201",
