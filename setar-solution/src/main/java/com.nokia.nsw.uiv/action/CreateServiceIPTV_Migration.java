...
import com.nokia.nsw.uiv.utils.LockManager;
    ...
    public Object doPost(ActionContext actionContext) throws Exception {
        ...
        for (CreateServiceIPTVRequest request : bulk.getServices()) {
            ...
            try {
                ...
                String lockKey = request.getOltName();
                Object oltlock = lockManager.getLock(lockKey);
                Object sublock=lockManager.getLock(subscriberName);
                Object ontLock=lockManager.getLock("ONT"+request.getOntSN());
                ...
                synchronized (sublock) {
                    ...
                    if (isSubscriberExist.get() && isSubscriptionExist.get() && isProductExist.get()) {
                        ...
                        response = new CreateServiceIPTVResponse("409", "Service already exist/Duplicate entry", Instant.now().toString(), subscriptionName, "ONT" + request.getOntSN());
                    }
                    ...
                    if (optRFS.isPresent()) {
                        ...
                        response = new CreateServiceIPTVResponse("409", "RFS already exists/Duplicate entry", Instant.now().toString(), subscriptionName, "ONT" + request.getOntSN());
                    } else {
                        rfs = new Service();
                ...
                Service rfs=serviceCustomRepository.findByDiscoveredName(rfsName).get();

                    String oltName = request.getOltName() == null ? "" : request.getOltName();
                LogicalDevice oltDevice;
                synchronized (oltlock) {
                    // ------------------- Logical Devices -------------------
                    // OLT Device
                ...
                synchronized (ontLock) {
                    ...
                    if (optVlan.isPresent()) {
                        ...
                        vlanRepository.save(vlanInterface);
