...
@Action
@Slf4j
public class CreateServiceFibernet_Migration implements HttpAction {
    ...
    public Class<?> getActionClass() {
        return CreateServiceFibernetBulkRequest.class;
    }
    ...
    public Object doPost(ActionContext actionContext) throws Exception {
        ...
        if (!(obj instanceof CreateServiceFibernetBulkRequest)) {
            return new CreateServiceFibernetResponse(
                    "400",
        ...
        CreateServiceFibernetBulkRequest bulk = (CreateServiceFibernetBulkRequest) obj;

        List<CreateServiceFibernetResponse> responses = new ArrayList<>();
